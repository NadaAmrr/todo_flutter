...
class TaskItem extends StatelessWidget {
  ...
  Widget widget = const CheckWidget();
    ...
    return Padding(
      ...
      child: Slidable(
        startActionPane: ActionPane(motion: DrawerMotion(), children: [
          ...
          }, label: AppStrings.edit,backgroundColor: AppColor.main,icon: Icons.edit),
          SlidableAction(onPressed: (context) {
            FirebaseFunctions.deleteTask(model.id);
          }, label: AppStrings.delete,backgroundColor: AppColor.red,icon: Icons.delete)
        ]),
        child: Container(
          // height: 100,
          ...
          child: TaskItemChild(title: model.title, color: color, subTitle: model.details, widget: widget,),
        ),
      ),
    );
  }
